...
function StringsToNums(strNums) {
    let nums = [];
    for(let i=0; i<strNums.length; i++) {
        nums.push(parseInt(strNums[i], 10));
    }
    return nums;
}
...
//find evens
let evenNums = [];
let nums = StringsToNums(strNums);
...
console.log("-------------------------------------------")
//add evens
let sumEvens = evenNums.reduce((sum, i) => sum + i);
console.log("Sum of even nums: ");
console.log(sumEvens);
console.log("-------------------------------------------")

/*
// Find the index of the first value when added to its index = 512 (#ATX!!)
const atxIdx = nums[512];
console.log("Index of first value: ");
console.log(atxIdx);
...
function getWeatherStateNames (weather) {
    let weatherStates = [];
...
function getUnique(weatherStates) {
    let uniqueWeatherStates = [];
    for(let i=0; i<weatherStates.length; i++) {
        if(!uniqueWeatherStates.includes(weatherStates[i]))
            uniqueWeatherStates.push(weatherStates[i]);
    }
